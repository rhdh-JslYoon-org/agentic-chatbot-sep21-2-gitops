...
A [vLLM]( https://github.com/redhat-ai-dev/developer-images/tree/main/model-servers/vllm/0.11.0) model server was deployed to serve the [ibm-granite/granite-3.3-8b-instruct](https://huggingface.co/ibm-granite/granite-3.3-8b-instruct) model.
...
The AI Software Template that was executed comes with a sample application. This application will be built from https://github.com/rhdh-JslYoon-org/agentic-chatbot-sep21-2, stored in [quay.io/rh-ee-lyoon-dh/agentic-chatbot-sep21-2](https://quay.io/rh-ee-lyoon-dh/agentic-chatbot-sep21-2) and deployed through ArgoCD. 
